...
import { ArrowBack, Store, Lock, Person, Business, Language, LocationOn, Description } from "@mui/icons-material";
    ...
    const handleLoginSubmit = async (e) => {
        ...
        try {
            ...
            if (res?.data.length === 0) {
                ...
                if (role !== 'retailer') {
                    setLoginErrMsg('Access denied. Retailer credentials required.');
                    return;
                }
                            ...
                            <Box component="form" onSubmit={handleLoginSubmit} noValidate sx={{ width: '100%' }}>
                                ...
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        border: 'none',
                                        '&:hover': {
                                            boxShadow: '0 6px 18px rgba(138, 43, 226, 0.6)',
